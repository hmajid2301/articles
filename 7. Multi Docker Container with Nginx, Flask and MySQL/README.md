...
database (Postgres). The main advantage of this is that it makes it easier to replace components of the application is required and also if an error occurs
easier to see which component is causing the error.
